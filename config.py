...
class Rkn_Bots(object):
    ...
    FORCE_SUB = os.environ.get("FORCE_SUB", "ALL_TV_SERIAL_BACKUP") 
    ...
    # default caption 
    DEF_CAP = os.environ.get("DEF_CAP", "<b><a href='https//:t.me/ALL_TV_SERIAL_BACKUP'>{file_name} Main Telegram Channel: @MRN_RIPPER</a></b>",
    )
